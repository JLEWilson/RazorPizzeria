...
namespace RazorPizzeria.Pages
{
    ...
    {
        public List<PizzasModel> Pizzas = new List<PizzasModel>()
        {
            ...
            new PizzasModel() { ImageTitle = "Carbonara", PizzaName = "Carbonara", BasePrice = 2, TomatoSauce = true, Cheese = true, Ham = true, Mushrooms = true, FinalPrice = 6 },
            ...
            new PizzasModel() { ImageTitle = "Mushroom", PizzaName = "Mushroom", BasePrice = 2, TomatoSauce = true, Cheese = true, Mushrooms = true, FinalPrice = 5 },
            ...
            new PizzasModel() { ImageTitle = "Vegetarian", PizzaName = "Vegetarian", BasePrice = 2, TomatoSauce = true, Cheese = true, Mushrooms = true, Pineapple = true, FinalPrice = 12 },
        };
        public void OnGet()
        {
        }
